...
int main(int argc, char *argv[]) {
    ...
    label1->setStyleSheet("font-size: 36pt; color: white;");
    ...
    QMovie *movie1 = new QMovie(":/images/resources/manji.gif");
    gifLabel1->setMovie(movie1);
    movie1->start();

    QLabel *gifLabel2 = new QLabel(&window);
    QMovie *movie2 = new QMovie(":/images/resources/tomdean.gif");
    ...
    // Connect a slot to the window's resize event if you need dynamic adjustment
