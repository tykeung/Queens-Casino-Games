...
int main(int argc, char *argv[]) {
    ...
    label1->setStyleSheet("font-size: 44pt");
    label1->setFont(font);
    blackjack_game_button->setStyleSheet("font-size: 12pt");
    blackjack_game_button->setFont(font);
    dice_game_button->setStyleSheet("font-size: 12pt");
    dice_game_button->setFont(font);
    mines_game_button->setStyleSheet("font-size: 12pt");
    mines_game_button->setFont(font);
    ...
    blackjack_backtomenu->setFont(font);
