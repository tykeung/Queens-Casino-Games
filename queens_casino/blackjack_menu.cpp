...
blackjack_menu::blackjack_menu(int window_width, float &balance, QWidget *parent) : QWidget(parent) {
    ...
    QFont font("Candara");
    QFont font2("BIZ UDPMincho Medium");
    ...
    dealer_hand->setFont(font2);
    dealer_hand->setAlignment(Qt::AlignCenter);
    dealer_hand->setStyleSheet("font-size: 20pt");

    QLabel *dealer_text = new QLabel("Dealer", this);
    dealer_text->setFont(font);
    dealer_text->setStyleSheet("font-size: 10pt");
    ...
    player_hand->setFont(font2);
    player_hand->setAlignment(Qt::AlignCenter);
    player_hand->setStyleSheet("font-size: 20pt");

    QLabel *player_text = new QLabel("You", this);
    player_text->setFont(font);
    player_text->setStyleSheet("font-size: 10pt");
    ...
    game_result->setStyleSheet("font-size: 12pt");
    /*
    ...
    */
    ...
    balance_display->setFont(font2);
    balance_display->setAlignment(Qt::AlignRight);

    QLabel *bet_word = new QLabel("Bet");
    bet_word->setFont(font);
    bet_word->setStyleSheet("font-size: 11pt");
    ...
    QObject::connect(start_game, &QPushButton::clicked, [double_down, game_result, bet, deck, playerHand, dealerHand, start_game, hit, stand, dealer_hand, player_hand, dealer_cards_images, player_cards_images, real_path, this] () {
        ...
        if (ok) {
            ...
            temp_card->setPixmap(img->scaled(64, 64, Qt::KeepAspectRatio));
    ...
    QObject::connect(hit, &QPushButton::clicked, [double_down, game_result, hit, stand, start_game, bet, deck, playerHand, dealerHand, player_hand, dealer_hand, dealer_cards_images, player_cards_images, real_path, this] () {
    ...
    QObject::connect(double_down, &QPushButton::clicked, [double_down, hit, stand, start_game, bet, deck, playerHand, dealerHand, player_hand, dealer_hand, game_result, dealer_cards_images, player_cards_images, real_path, this] () {
        ...
        if (playerTotal > 21) {
            ...
            playerHand->clear();
            dealerHand->clear();
            game_result->setText("You bust. You lose " + QString::number(winnings));
        } else {
            if (dealerTotal > 21) {
                roll_clicked(2 * bet->text().toFloat());
